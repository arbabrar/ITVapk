 ...
 */
public class ModoCargaActivity extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modo_carga);
                ...
                if(FirebaseAuth.getInstance().getCurrentUser()!=null ){
                    if(prefs.estalogueado()){
                        if(prefs.tienepunto()){
                            ...
                            //Intent intent= new Intent(CargaActivity.this,NroCertificadoActivity.class);

                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(intent);
                        }else{
                            Intent intent= new Intent(ModoCargaActivity.this,DepartamentoActivity.class);
                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(intent);
                        }
                    }else{
